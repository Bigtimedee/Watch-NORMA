...
/**
 * Creates a fully-configured MCP Server instance with all 6 NORMA ad tools
 * registered. In MCP SDK 1.x, each Server is 1:1 with a transport, so HTTP/SSE
 * connections each call this factory to get a fresh, independent instance.
 */
export function createNormaServer(): Server {
